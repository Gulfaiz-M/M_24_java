        ...
        while (infiniteLoop) {
            ...
            if (option == 1) {
                ...
                if (accountIndex > size) {
                    ...
                    System.out.println(accountName[accountIndex] + " your balance is " + 
                ...
                for (int i = 100; i < size; i++) {
                    System.out.println("Account Number: " + i + ", Name: " + 
                ...
                System.out.println("Terminating...");
                System.out.println("Developed & Managed by Gulfaiz@Codingal");
